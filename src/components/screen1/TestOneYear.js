...
בדיקת תיק הביטוח על ידי סוכן מקצועי נועדה לוודא שפוליסות הביטוח השונות מספקות את הכיסויים הביטוחיים, ומתאימות  ביותר לצרכי הלקוח.
הבדיקה כוללת את עלויות דמי הניהול, כאשר במקרים רבים אנו מגלים שחיקה של עשרות אלפי שקלים לגיל פרישה. 
מתי מומלץ לבצע בדיקה של תיק הביטוח?
מרבית המבוטחים אינם מבצעים מעקב אחר עלויות הביטוח אשר הם משלמים ואינם מספיק מקצועיים לבצע שינויים בתיק כאשר יש שינוי במצב המשפחתי ולכן מומלץ לבצע בדיקה פעם בשנתיים עד שלוש שנים. כאשר המטרה היא להבטיח שמרכיבי התיק מספקים את התנאים האופטימליים ללקוח ולבני משפחתו.
אנו דואגים לבצע בדיקה לכל לקוחותינו באופן יזום אחד לשנתיים ובכך מבטיחים ללקוחותינו שקט נפשי.
